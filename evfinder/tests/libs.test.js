...
describe('Helper Tests', () => {
  test('Input should be Title Cased', () => {
    ...
    expect(libs.titleCase("This is the thirty-third day of the month — wait, no it's not!")).toBe(
      "This Is The Thirty-third Day Of The Month — Wait, No It's Not!"
    )
  })
})
...
describe('URL Validation Tests', () => {
  ...
  test('Incorrect URL with query params should return false', () => {
    expect(
      libs.isValidUrlPath('/inventory/2024/chevrolet/Lightning-Bolt?zipcode=90210&radius=10')
    ).toBeFalsy()
  })
